...
function Hero (props){
    return(
        ...
        <div className='flex flex-row justify-around h-full w-[90%] items-center flex-wrap-reverse sm:flex-nowrap'>
            ...
            <h1 className='sm:text-4xl md:text-6xl text-2xl text-aesthetic-white font-Main font-medium text-left'>Find The Exclusive Shoe</h1>
            <p className= 'text-left text-sm md:text-lg text-text-gray mt-4 w-4/5'>Step into style with our exclusive collection of shoes, crafted for comfort and designed to impress. Discover quality, fashion, and unbeatable prices all in one place!
